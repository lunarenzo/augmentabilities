...
mavenPublishing {
    ...
    pom {
        ...
        url.set("https://github.com/lunatech/AugmentAbilities")
        ...
        scm {
            url.set("https://github.com/lunatech/AugmentAbilities")
            connection.set("scm:git:git://github.com/lunatech/AugmentAbilities.git")
            developerConnection.set("scm:git:ssh://github.com:lunatech/AugmentAbilities.git")
        }
    }
