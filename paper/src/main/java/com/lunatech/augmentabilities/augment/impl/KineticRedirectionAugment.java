...
public class KineticRedirectionAugment implements Augment {
    ...
    public String getName() {
        return "Kinetic Redirection";
    }

    @Override
    public List<String> getDescription() {
        return List.of("<gray>Passive:</gray>", "Receiving <light_purple>projectile damage</light_purple>", "stores charges. Your next melee attack", "deals <green>+1.5 damage</green> per charge (max 3).");
    }
