package com.lunatech.augmentabilities.database.migration.migrations;

import com.lunatech.augmentabilities.database.migration.MigrationUtils;
...
/**
 * AugmentAbilities Java Flyway migration using jOOQ.
 * This is useful if you don't like sql files or you want do programmatic processing of data when migrating.
 */
@SuppressWarnings("unused")
public class V4__augmentabilities_test extends BaseJavaMigration {
    @Override
