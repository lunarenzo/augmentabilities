package com.lunatech.augmentabilities.config.migration;
...
public final class Migration implements ConfigurationTransformation {
    ...
    public static final class Builder {
         ...
         *
         * <p>AugmentAbilities, move {@code language} into {@code settings}, producing {@code settings.language}:
         ...
         *
         * <p>AugmentAbilities, move {@code old-key} to {@code section.new-key}:
